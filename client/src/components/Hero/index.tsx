...
import { Car, heroCars } from "./utils";
...
const HeroHeader = ({ car }: { car: Car }) => (
  <AnimatePresence mode="wait">
    <motion.h2
      key={car.name}
      className={`text-[40px] text-center lg:text-left -mt-5 block lg:block lg:text-[128px] leading-none drop-shadow-2xl ${kalnia.className}`}
...
const HeroColorBox = ({ car }: { car: Car }) => (
  <motion.div
    ...
    animate={{ backgroundColor: car.color }}
